...
import (
	...
	v1 "github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/floatingip/v1/apis/listers/floatingip/v1"
...
func (f *floatingIPInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&floatingipv1.FloatingIP{}, f.defaultInformer)
}
