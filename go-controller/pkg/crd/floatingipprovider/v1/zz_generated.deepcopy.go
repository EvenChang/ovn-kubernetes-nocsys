...
func (in *FloatingIPProviderStatus) DeepCopyInto(out *FloatingIPProviderStatus) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]FloatingIPProviderStatusItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FloatingIPProviderStatusItem) DeepCopyInto(out *FloatingIPProviderStatusItem) {
	*out = *in
	if in.FloatingIPs != nil {
		in, out := &in.FloatingIPs, &out.FloatingIPs
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FloatingIPProviderStatusItem.
func (in *FloatingIPProviderStatusItem) DeepCopy() *FloatingIPProviderStatusItem {
	if in == nil {
		return nil
	}
	out := new(FloatingIPProviderStatusItem)
	in.DeepCopyInto(out)
	return out
}
