...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/floatingipprovider/v1/apis/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1Interface interface {
	RESTClient() rest.Interface
	FloatingIPProvidersGetter
}
...
func (c *K8sV1Client) FloatingIPProviders() FloatingIPProviderInterface {
	return newFloatingIPProviders(c)
}
