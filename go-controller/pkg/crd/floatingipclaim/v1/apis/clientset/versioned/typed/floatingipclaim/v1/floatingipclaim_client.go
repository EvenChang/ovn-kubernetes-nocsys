...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/floatingipclaim/v1/apis/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1Interface interface {
	RESTClient() rest.Interface
	FloatingIPClaimsGetter
}
...
func (c *K8sV1Client) FloatingIPClaims() FloatingIPClaimInterface {
	return newFloatingIPClaims(c)
}
